...
class HourPickerBehavior : BaseBehavior, TimePickerContract.Behavior {
    ...
    constructor(timePickerView: TimePickerView, hoursPickerPath: PickerPath) : super(timePickerView, hoursPickerPath)
    constructor(timePickerView: TimePickerView, hoursPickerPath: PickerPath, colors: IntArray) : super(timePickerView, hoursPickerPath, colors)
