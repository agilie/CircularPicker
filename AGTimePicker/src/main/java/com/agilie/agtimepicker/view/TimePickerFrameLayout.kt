...
import com.agilie.agtimepicker.PickerPagerAdapter

/**Action Flow
 * 1) Add TimeViewPagerContainer
 * 2) Set correct Layout params for TimeViewPagerContainer
 * 3) In TimeViewPagerContainer set TimePickerView
 * 4)
 *
 *
 *
...
class TimePickerFrameLayout : FrameLayout {

    var timeViewPagerContainer: TimeViewPagerContainer? = null
    ...
    private fun init(attrs: AttributeSet?) {
        timeViewPagerContainer = TimeViewPagerContainer(context)
