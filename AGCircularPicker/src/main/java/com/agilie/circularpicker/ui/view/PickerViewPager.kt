...
class PickerViewPager : ViewPager {
    ...
    fun onAddView(view: CircularPickerView) {
        ...
        this@PickerViewPager.addView(view)
        pagerAdapter.addView(view)
        pagerAdapter.notifyDataSetChanged()
        adapter = pagerAdapter
    }

    fun getView(position: Int) = pagerAdapter.views[position]
        ...
        view.apply {
            touchListener = object : CircularPickerView.TouchListener {
                override fun onViewTouched(pointF: PointF, event: MotionEvent?) {
                    ...
                    picker = pickerPoint
                    this@PickerViewPager.swipeEnable = !pickerPoint
                    this@PickerViewPager.onInterceptTouchEvent(event)
                }
            }
        }
    }
